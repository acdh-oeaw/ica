...
export default function HomePage(): JSX.Element {
  ...
  const geojson = {
    ...
    features: [
      {type: 'Feature', geometry: {type: 'Point', coordinates: [16.35323,  48.240234]}, properties: {'Name': 'John Gunther', 'Type': 'Person', 'Adress' : 'Dollinergasse 5, 1190, Vienna'}},
      {type: 'Feature', geometry: {type: 'Point', coordinates: [16.36735,  48.213089]}, properties: {'Name': 'Café Louvre', 'Type': 'Place', 'Adress' : 'Wipplingerstraße 27, 1010 Vienna'}},
      {type: 'Feature', geometry: {type: 'Point', coordinates: [16.361413,  48.197215]}, properties: {'Name': 'Dorothy Thompson', 'Type': 'Person', 'Adress' : 'Rechte Wienzeile 31, 1040, Vienna'}},
      {type: 'Feature', geometry: {type: 'Point', coordinates: [16.334765,  48.233707]}, properties: {'Name': 'Richard Beer-Hofmann', 'Type': 'Person', 'Adress' : 'Hasenauerstraße 59, 1190, Vienna'}},
      {type: 'Feature', geometry: {type: 'Point', coordinates: [16.334765,  48.233707]}, properties: {'Name': 'Miriam Beer-Hofmann Lens', 'Type': 'Person', 'Adress' : 'Hasenauerstraße 59, 1190, Vienna'}},
      {type: 'Feature', geometry: {type: 'Point', coordinates: [16.36320,  48.21864]}, properties: {'Name': 'Tiffany Burlingham', 'Type': 'Person', 'Adress' : 'Berggasse 19, 1090, Vienna'}},
      {type: 'Feature', geometry: {type: 'Point', coordinates: [16.357269,  48.215329]}, properties: {'Name': 'Muriel Gardiner', 'Type': 'Person', 'Adress' : 'Frankgasse 1, 1090, Vienna'}},
      {type: 'Feature', geometry: {type: 'Point', coordinates: [16.36320,  48.21864]}, properties: {'Name': 'Siegmund Freud', 'Type': 'Person', 'Adress' : 'Berggasse 19, 1090, Vienna'}},
      {type: 'Feature', geometry: {type: 'Point', coordinates: [16.37989,  48.188373]}, properties: {'Name': 'Thornton Wilder', 'Type': 'Person', 'Adress' : 'Wiedner Gürtel 6, 1040, Vienna'}},
      {type: 'Feature', geometry: {type: 'Point', coordinates: [16.383845,  48.202252]}, properties: {'Name': 'William Shirer', 'Type': 'Person', 'Adress' : 'Reisnerstrasse 15, 1030 Vienna'}},
    ]
  };
  ...
  const relationships = {
    ...
    'Helped to emigrate': {'Thornton Wilder': ['Richard Beer-Hofmann', 'Miriam Beer-Hofmann Lens']}
  };
