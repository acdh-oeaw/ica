export const persons = new Map([
	...
	[
		"406",
		{
			...
			notes:
				"Benjamin W. Huebsch was a prominent publisher and chief transatlantic mediator who had a network of close relationships and friendships with numerous (Austrian) writers . Among others, he published the work of Louis Untermeyer, Gerhart Hauptmann, and Franz Werfel. He acquired the rights for the translations of books by many European writers and supported and facilitated the lives of emigrants (see Zacharasiewicz, Transatlantic Networks, p. 56). In 1925, the publishing house B. W. Huebsch (est. 1900) was merged with the Viking Press, where Huebsch worked as an editor and vice president.",
			gender: "male",
	...
	[
		"520",
		{
			...
			events: new Set(["1560", "5223", "6332", "7084"]),
		},
	],
	[
		"477",
	...
	[
		"462",
		{
			...
			institutions: new Set(["2153", "2155", "9943"]),
			events: new Set([]),
		},
	],
	[
		"463",
		{
			...
			references:
				'Stanzel, Franz. "Erinnerungen an die Anglistin Helene Richter anlässlich der Wiederkehr ihres 150. Geburtstages 2011." Anglia - Zeitschrift für englische Philologie 129 (2011), 321-332.',
			notes: "",
			gender: "female",
			professions: new Set(["8893", "9027"]),
			persons: new Set(["772", "2150"]),
			places: new Set(["2151", "5833"]),
			institutions: new Set(["2152", "9944"]),
			events: new Set([]),
		},
	],
	[
	...
	[
		"1337",
		{
			...
			id: "1337",
			label: "Karl Farkas",
			startDate: "1893-10-28",
			endDate: "1971-05-16",
			startDateWritten: "1893-10-28",
			endDateWritten: "1971-05-16",
			references:
				'Schreckenberger, Helga. "Gelungene Heimkehr? Der Fall Karl Farkas." in: Return from Exile, 2017, 119-133.\r\nLackner, Herbert. Rückkehr in die fremde Heimat\r\nDie vertriebenen Dichter und Denker und die ernüchternde Nachkriegs-Wirklichkeit. Berlin: Ueberreuter Verlag, 2021. \r\nMarkus, Georg, ed. Das grosse Karl Farkas Buch: Sein Leben, seine besten Texte, Conférencen und Doppelconférencen. Wien: Amalthea Verlag, 1993.',
			notes:
				"Karl Farkas had to eventually flee to the US without his wife and son as his son had a disability which resulted in him not being allowed to enter the US. His sisters Elisabeth and Katharina as well as his nephew Felix died during the Nazi regime. After his return to Austria he did not talk about his Jewish identity and had to work with Nazi collaborators, such as Marika Rökk, Paula Wessely and Willy Forst out of financial necessity. While he was speaking German with a strong Jiddish accent until 1938, by 1945 this had completely disappeared.",
			gender: "male",
			professions: new Set(["6524", "10453", "10482", "10483", "10486", "10488"]),
			persons: new Set(["6467", "9238", "9225", "9226", "9292"]),
			places: new Set(["1338", "1370", "1381", "1382", "5134", "5135", "7763", "7771"]),
			institutions: new Set(["1372", "1380", "2669", "7775", "9217", "9224", "9234", "9277"]),
			events: new Set(["7765"]),
		},
	],
	[
		"7030",
		{
			...
			references: "",
			notes:
				"The successful non-Jewish composer was an opponent of the Nazi regime who assisted Jewish friends in their escape from Nazi Germany. In March 1940, departure from Genoa to the US where he was active as a composer.",
			gender: "male",
			professions: new Set(["6517", "10459", "10928"]),
			persons: new Set(["9225", "9238"]),
			places: new Set([
				"7032",
				"7033",
				"7781",
			...
			institutions: new Set(["9437", "9440", "9447", "9450", "9453", "9462"]),
			events: new Set(["7791"]),
		},
	],
	[
	...
	[
		"8756",
		{
			kind: "person",
			id: "8756",
			label: "Bettina Ehrlich-Bauer",
			startDate: "1903-03-10",
			endDate: "1985-10-10",
			startDateWritten: "1903-03-10",
			endDateWritten: "1985-10-10",
			references: "",
			notes: "",
			gender: "female",
			professions: new Set(["6890", "7917", "8485", "8546", "10308"]),
			persons: new Set([]),
			places: new Set(["8789", "8794", "8795", "8798"]),
			institutions: new Set([]),
			events: new Set([]),
		},
	],
	[
		"8809",
		{
			kind: "person",
			id: "8809",
			label: "Charles Sealsfield",
			startDate: "1793-03-03",
			endDate: "1864-05-26",
			startDateWritten: "1793-03-03",
			endDateWritten: "1864-05-26",
			references:
				'Kriegleder, Wynfrid. "Looking for a Scapegoat. Germanophone Novelists of the 19th and 20th Century Depicting a Polarized America." Polarization in the North Atlantic Triangle. Vienna: Verlag der ÖAW, 2023.',
			notes:
				"Sealsfield wrote mostly about the Old South from an idyllic and decidedly American perspective that depicts the plantations in a positive light, leaving critics to wonder whether he was in fact romanticising and supporting slavery, or encouraging readers to be critical and perceptive of his narrator's contradictions.",
			gender: "male",
			professions: new Set(["7270"]),
			persons: new Set([]),
			places: new Set(["8812", "8821", "8822"]),
			institutions: new Set(["8820"]),
			events: new Set([]),
		},
	],
	[
		"8986",
		{
			kind: "person",
			id: "8986",
			label: "Siegfried Lipiner",
			startDate: "1856-10-24",
			endDate: "1911-12-30",
			startDateWritten: "1856-10-24",
			endDateWritten: "1911-12-30",
			references:
				"Celestini, Frederico. „Gustav Mahler’s Symphonic Transcendence and its Counterparts“ Religion in the Secular Age. Vienna: Verlag der ÖAW.",
			notes: "",
			gender: "male",
			professions: new Set(["6389", "6403", "6466", "7838"]),
			persons: new Set([]),
			places: new Set(["8989", "9025"]),
			institutions: new Set(["9003", "9023", "9024", "9028"]),
			events: new Set(["9043"]),
		},
	],
	[
		"8612",
		{
			...
			notes: "",
			gender: null,
			professions: new Set(["6389", "7146", "8224", "8431", "11143"]),
			persons: new Set([]),
			places: new Set([
				"5886",
				"5890",
